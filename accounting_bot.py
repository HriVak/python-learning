...
# ——— НАСТРОЙКИ ———
# Ключът се взима от environment variable (безопасно, не се вижда в GitHub)
llm = ChatGroq(
    model="llama-3.1-70b-versatile",
    temperature=0.3,
    groq_api_key=st.secrets.get("GROQ_API_KEY", "dummy_key_for_local_test")  # В Streamlit Cloud: взима от secrets
)
